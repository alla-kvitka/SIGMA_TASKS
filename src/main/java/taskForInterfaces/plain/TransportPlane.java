...
public class TransportPlane extends Airplane implements Transitable {
    ...
    public void loadCargo() {
        System.out.println("Transport Plane loading");
    }

    @Override
    public void unloadCargo() {
        System.out.println("Transport Plane unloading");
    }
}
